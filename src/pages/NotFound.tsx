    ...
    <div>
      ...
      >
        ...
        <button
          type="button"
          onClick={handleHome}
          className="min-w-fit py-[1%] px-[3%] rounded-none bg-red text-white font-bold text-[14px] hover:bg-white hover:border-red hover:border-[2px] hover:border-solid hover:text-black"
        >
          برگشت به صفحه اصلی
        </button>
      </div>
